...
function updateScoreCounter() {
    ...
    // Создаем и отправляем пользовательское событие для оповещения других компонентов
    const event = new CustomEvent('score-counter-updated', { 
        detail: { 
            totalScore: totalScore,
            averageScore: averageScore,
            questionCount: pointsInputs.length
        }
    });
